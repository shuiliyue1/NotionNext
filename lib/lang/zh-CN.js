export default {
  ...
  COMMON: {
    ...
    COPYRIGHT_NOTICE: '采用 CC BY-NC-SA 4.0 许可协议，转载请注明出处。本站旨在聚合展示各大运营商通信产品信息，所展示内容均来源于运营商官方公开资料，仅供用户比较与决策参考。运营商政策可能随时调整，本站信息或存在更新延迟。所有相关细则及最终解释权均归运营商所有，请以运营商发布的最新信息为准。',
